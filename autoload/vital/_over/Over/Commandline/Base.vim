...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_over#Over#Commandline#Base#import() abort
  ...
  execute join(['function! vital#_over#Over#Commandline#Base#import() abort', printf("return map({'_vital_depends': '', 'make_plain': '', 'is_input_waiting': '', 'make': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
